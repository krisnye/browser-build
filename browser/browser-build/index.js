(function(){require.register('browser-build',function(module,exports,require){// Generated by CoffeeScript 1.6.2
(function() {
  var buildFile, buildIncludes, config, copyRequire, copySourceMap, deleteFile, fs, getModuleId, getOutputFile, np, utility, watcher;
  ...
  buildIncludes = function(config) {
    ...
    return console.log("Created " + includeFile);
  };
  ...
  copyRequire = function(config) {
    ...
    if (!fs.existsSync(target)) {
      ...
      return console.log("Copied " + target);
    }
  };
