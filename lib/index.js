...
(function() {
  ...
  copyRequire = function(config) {
    ...
    return utility.copy(source, target);
  };
  ...
  check = function(config) {
    ...
    fixOptions = function(name, options, root, source) {
      ...
      if (Object.isString(options)) {
        return config.input[name] = {
          name: name,
          main: 'index.js',
          directory: np.normalize(options)
        };
      } else if (options === true || (options == null)) {
  ...
  excludeModule = function(config, moduleId) {
    var value;
